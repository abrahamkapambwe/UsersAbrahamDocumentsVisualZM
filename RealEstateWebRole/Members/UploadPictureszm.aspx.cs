...
{
    public partial class UploadPictureszm : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            {
                hdfAttributeID.Value = "";
                hdfAttributeStateID.Value = "";
                hdfPriceID.Value = "";
                hdfPropertyID.Value = "";
        ...
        protected void Property_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    address = txtStreetnumber.Text + "+" + txtStreetname.Text + "+" + txtSuburb.Text + "+" + ddlProvince.SelectedValue + "+" + txtCity.Text + "+" + "zm";
